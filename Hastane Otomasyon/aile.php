...
?>
        <div class="uyarı">
            <b>Aile Hekimliği Randevu Kaydınız Başarıyla Alındı.Randevularınıza <a href="randevu.php">Randevularım</a> Bölümünden Bakabilirsiniz</b>
        </div> 
<?php
    }
    if($_GET["status"] == "no"){
        ?>
        <div class="hata">
            <b>Aile Hekimliği Randevu Kaydı Alınırken Hata Oluştu</b>
        </div> 
<?php
    }
}
?> 
<h2 id="aileh2">Aile Hekimi Randevusu Al</h2> 
<!-- ****************aile hemimi randevusu ********************-->
<div class="orta_div" id="ailehekimi_div">
    ...
    <button name="aile_randevu_kaydet">Randevu Kaydet</button>
    </form>
